...
cartasIzquierda.forEach((elemento, indice, array) => {
...
function game() {
  ...
  setTimeout(() => {
    ...
    document.querySelector(".ladoIzquierdo img.opacity-0").classList.remove("opacity-0");
    document.querySelector(".ladoDerecho img.opacity-0").classList.remove("opacity-0");
